...
class ImagePreprocessing:
    ...
    def resize(self, image):
        ...
        middle_width = [image[division_height][division_width - 1], image[division_height][division_width],
    ...
    def segment(self, img):
        ...
        for i in range(len(cnts)):
            ...
            try:
                ...
                attributes = {'index': i, 'image': result_image.copy(), 'xmin': _x, 'xmax': _x + _w, 'ymin': _y,
                    'ymax': _y + _h, 'w': _w, 'h': _h, 'centroid': [(_x + (_x + _w)) / 2, (_y + (_y + _h)) / 2]}
